    ...
    const data = {
      ...
      nutrisi: {
        ...
        karbohidrat: {
          ...
          fiber: productData.nutrisi.fiber,
        },
        lemak: {
      ...
      total_n_points: productData.totalNPoints,
      total_p_points: productData.totalPPoints,
      nutrient_profiling_class: productData.nutrient_profiling_class,
      nutrient_profiling_score: productData.nutrient_profiling_score,
